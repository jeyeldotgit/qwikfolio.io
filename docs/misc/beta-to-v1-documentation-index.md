...
4. **Database Management**: See [DATABASE.md](./DATABASE.md) for schema, indexes, and maintenance
...
- [`DATABASE.md`](./DATABASE.md) - Complete database documentation (ERD, data dictionary, migrations)
...
- **DATABASE**: Update when schema changes or new migrations are added
...
| DATABASE               | 1.0     | Jan 2025     | Apr 2025    |
...
- Review ERD, data dictionary, and migration history
